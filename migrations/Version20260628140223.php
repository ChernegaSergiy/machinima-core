 ...
 */
final class Version20260628140223 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__comments AS SELECT id, content_id, user_id, author_name, text, created_at, parent_id, updated_at FROM comments');
        $this->addSql('DROP TABLE comments');
        $this->addSql('CREATE TABLE comments (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, content_id INTEGER NOT NULL, user_id INTEGER NOT NULL, author_name VARCHAR(255) DEFAULT NULL, text CLOB NOT NULL, created_at CLOB DEFAULT \'CURRENT_TIMESTAMP\', parent_id INTEGER DEFAULT NULL, updated_at CLOB DEFAULT NULL, CONSTRAINT FK_5F9E962A84A0A3ED FOREIGN KEY (content_id) REFERENCES content (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_5F9E962AA76ED395 FOREIGN KEY (user_id) REFERENCES user_data (user_id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_5F9E962A727ACA70 FOREIGN KEY (parent_id) REFERENCES comments (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO comments (id, content_id, user_id, author_name, text, created_at, parent_id, updated_at) SELECT id, content_id, user_id, author_name, text, created_at, parent_id, updated_at FROM __temp__comments');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__comments AS SELECT id, author_name, text, created_at, updated_at, content_id, user_id, parent_id FROM comments');
        $this->addSql('DROP TABLE comments');
        $this->addSql('CREATE TABLE comments (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, author_name VARCHAR(255) DEFAULT NULL, text CLOB NOT NULL, created_at CLOB DEFAULT \'CURRENT_TIMESTAMP\', updated_at CLOB DEFAULT NULL, content_id INTEGER NOT NULL, user_id INTEGER NOT NULL, parent_id INTEGER DEFAULT NULL, CONSTRAINT FK_5F9E962A84A0A3ED FOREIGN KEY (content_id) REFERENCES content (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_5F9E962AA76ED395 FOREIGN KEY (user_id) REFERENCES user_data (user_id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_5F9E962A727ACA70 FOREIGN KEY (parent_id) REFERENCES comments (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO comments (id, author_name, text, created_at, updated_at, content_id, user_id, parent_id) SELECT id, author_name, text, created_at, updated_at, content_id, user_id, parent_id FROM __temp__comments');
        $this->addSql('DROP TABLE __temp__comments');
        $this->addSql('CREATE INDEX IDX_5F9E962A84A0A3ED ON comments (content_id)');
        $this->addSql('CREATE INDEX IDX_5F9E962AA76ED395 ON comments (user_id)');
        $this->addSql('CREATE INDEX IDX_5F9E962A727ACA70 ON comments (parent_id)');
