 ...
 */
final class Version20260702115840 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_followers (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, created_at DATETIME NOT NULL, user_id INTEGER NOT NULL, author_id INTEGER NOT NULL, CONSTRAINT FK_84E87043A76ED395 FOREIGN KEY (user_id) REFERENCES user_data (user_id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_84E87043F675F31B FOREIGN KEY (author_id) REFERENCES authors (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('CREATE INDEX IDX_84E87043A76ED395 ON user_followers (user_id)');
        $this->addSql('CREATE INDEX IDX_84E87043F675F31B ON user_followers (author_id)');
