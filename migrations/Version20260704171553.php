 ...
 */
final class Version20260704171553 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO comments (id, content_id, user_id, text, created_at, parent_id, updated_at) SELECT id, content_id, user_id, text, created_at, parent_id, updated_at FROM __temp__comments');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comments ADD COLUMN author_name VARCHAR(255) DEFAULT NULL');
