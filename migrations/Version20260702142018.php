 ...
 */
final class Version20260702142018 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_data (user_id INTEGER NOT NULL, user_state CLOB DEFAULT NULL, current_panel INTEGER DEFAULT NULL, current_page CLOB DEFAULT NULL, role CLOB DEFAULT NULL, created_at CLOB DEFAULT \'CURRENT_TIMESTAMP\', PRIMARY KEY (user_id))');
