 ...
 */
final class Version20260703151134 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__authors AS SELECT id, name, biography, channel_link, created_at, state, telegram_user_id FROM authors');
        $this->addSql('DROP TABLE authors');
        $this->addSql('CREATE TABLE authors (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name CLOB NOT NULL, biography CLOB DEFAULT NULL, channel_link CLOB DEFAULT NULL, created_at CLOB DEFAULT \'CURRENT_TIMESTAMP\', state CLOB DEFAULT NULL, user_id INTEGER DEFAULT NULL, CONSTRAINT FK_8E0C2A51A76ED395 FOREIGN KEY (user_id) REFERENCES user_data (user_id) ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO authors (id, name, biography, channel_link, created_at, state, user_id) SELECT id, name, biography, channel_link, created_at, state, telegram_user_id FROM __temp__authors');
        $this->addSql('DROP TABLE __temp__authors');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__authors AS SELECT id, name, biography, channel_link, created_at, state, user_id FROM authors');
        $this->addSql('DROP TABLE authors');
        $this->addSql('CREATE TABLE authors (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name CLOB NOT NULL, biography CLOB DEFAULT NULL, channel_link CLOB DEFAULT NULL, created_at CLOB DEFAULT \'CURRENT_TIMESTAMP\', state CLOB DEFAULT NULL, telegram_user_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO authors (id, name, biography, channel_link, created_at, state, telegram_user_id) SELECT id, name, biography, channel_link, created_at, state, user_id FROM __temp__authors');
        $this->addSql('DROP TABLE __temp__authors');
