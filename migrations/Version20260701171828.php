 ...
 */
final class Version20260701171828 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE notifications ADD COLUMN target_type VARCHAR(50) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE __temp__content');
        $this->addSql('CREATE INDEX IDX_FEC530A9DE12AB56 ON content (created_by)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__notifications AS SELECT id, type, target_id, message, is_read, created_at, user_id FROM notifications');
        $this->addSql('DROP TABLE notifications');
        $this->addSql('CREATE TABLE notifications (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, type VARCHAR(50) NOT NULL, target_id INTEGER DEFAULT NULL, message CLOB NOT NULL, is_read BOOLEAN DEFAULT 0 NOT NULL, created_at CLOB DEFAULT \'CURRENT_TIMESTAMP\', user_id INTEGER NOT NULL, CONSTRAINT FK_6000B0D3A76ED395 FOREIGN KEY (user_id) REFERENCES user_data (user_id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO notifications (id, type, target_id, message, is_read, created_at, user_id) SELECT id, type, target_id, message, is_read, created_at, user_id FROM __temp__notifications');
