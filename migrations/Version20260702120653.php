 ...
 */
final class Version20260702120653 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__content_interactions AS SELECT id, user_id, content_id, interaction_type, created_at FROM content_interactions');
        $this->addSql('DROP TABLE content_interactions');
        $this->addSql('CREATE TABLE content_interactions (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, content_id INTEGER NOT NULL, interaction_type CLOB NOT NULL, created_at CLOB DEFAULT \'CURRENT_TIMESTAMP\', CONSTRAINT FK_57037802A76ED395 FOREIGN KEY (user_id) REFERENCES user_data (user_id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_5703780284A0A3ED FOREIGN KEY (content_id) REFERENCES content (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO content_interactions (id, user_id, content_id, interaction_type, created_at) SELECT id, user_id, content_id, interaction_type, created_at FROM __temp__content_interactions');
        $this->addSql('DROP TABLE __temp__content_interactions');
        $this->addSql('CREATE INDEX IDX_5703780284A0A3ED ON content_interactions (content_id)');
        $this->addSql('CREATE INDEX IDX_57037802A76ED395 ON content_interactions (user_id)');
        $this->addSql('CREATE UNIQUE INDEX unique_user_content_interaction ON content_interactions (user_id, content_id, interaction_type)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE __temp__content');
        $this->addSql('CREATE INDEX IDX_FEC530A9DE12AB56 ON content (created_by)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__content_interactions AS SELECT id, interaction_type, created_at, user_id, content_id FROM content_interactions');
        $this->addSql('DROP TABLE content_interactions');
        $this->addSql('CREATE TABLE content_interactions (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, interaction_type CLOB NOT NULL, created_at CLOB DEFAULT \'CURRENT_TIMESTAMP\', user_id INTEGER NOT NULL, content_id INTEGER NOT NULL, CONSTRAINT FK_57037802A76ED395 FOREIGN KEY (user_id) REFERENCES user_data (user_id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_5703780284A0A3ED FOREIGN KEY (content_id) REFERENCES content (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO content_interactions (id, interaction_type, created_at, user_id, content_id) SELECT id, interaction_type, created_at, user_id, content_id FROM __temp__content_interactions');
        $this->addSql('DROP TABLE __temp__content_interactions');
        $this->addSql('CREATE INDEX IDX_57037802A76ED395 ON content_interactions (user_id)');
        $this->addSql('CREATE INDEX IDX_5703780284A0A3ED ON content_interactions (content_id)');
        $this->addSql('CREATE UNIQUE INDEX unique_user_content_interaction ON content_interactions (user_id, content_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__user_data AS SELECT user_id, user_state, current_panel, current_page, role FROM user_data');
        $this->addSql('DROP TABLE user_data');
